      ...
      <nav aria-label="Page navigation">
        <ul class="pagination">
          ...
          for ($i = $start_page; $i <= $end_page; $i++) { ?>
            <li class='page-item p-2 border border-warning' <?php if ($page == $i) echo 'style="background-color: yellow"'; ?>>
              <a class='<?php if ($page == $i) echo 'text-black';
                        else echo 'text-warning'; ?>' href='?page= <?php echo $i ?> '><?php echo $i ?></a>
            </li>
