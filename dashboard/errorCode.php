        ...
        <div class="row">
            <div class="col-md-5 grid-margin">
                <div class="card" style="background-color: #212359; color: #ffff;">
                    <div class="card-body">
                        <h4 class="card-title"><?php echo isset($_GET['id']) ? "Update Support Record" : "Record Support" ?></h4>
                        <?php
                        if (isset($_GET['error'])) {
                        ...
                        <form class="forms-sample" action="../backend/recordError.php" method="post" enctype="multipart/form-data">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" style="background-color: darkgray;" id="exampleInputUsername2" name="ecode" placeholder="NT-IT-Error-01" value="<?php echo isset($_GET['id']) ? $employeeData['name'] : '' ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Error</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" style="background-color: darkgray;" id="exampleInputUsername2" name="error" placeholder="Software installation" value="<?php echo isset($_GET['id']) ? $employeeData['email'] : '' ?>">
                                </div>
                            </div>
