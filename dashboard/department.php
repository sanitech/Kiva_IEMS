    ...
    <div class="content-wrapper" style="background-color: #ffff;">
        <div class="row">
            <div class="col-md-6 grid-margin    ">
                <div class="card" style="background-color: #212359;">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="../backend/recordDepartment.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text text-dark" class="form-control" style="background-color: darkgray;" id="exampleInputUsername2" name="dep" placeholder="Department Name">
                                </div>
                            </div>
